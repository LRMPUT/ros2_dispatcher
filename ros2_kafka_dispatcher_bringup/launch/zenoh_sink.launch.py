...
def generate_launch_description():
    ...
    arguments = [
        ...
        DeclareLaunchArgument("container_name", default_value="zenoh_sink_container"),
            ...
            LoadComposableNodes(
                ...
                composable_node_descriptions=[
                    ComposableNode(
                        ...
                        parameters=zenoh_sink_parameters,
                    ),
                ],
            )
        ],
    ...
    standalone_node = Node(
        ...
        package="zenoh_sink",
        executable="zenoh_sink_node_exe",
        name="zenoh_sink",
        output="screen",
