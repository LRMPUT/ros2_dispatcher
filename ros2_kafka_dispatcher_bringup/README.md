...
For a deeper, step-by-step walkthrough (including troubleshooting tips and common overrides), see [`docs/tutorial.md`](docs/tutorial.md) and the beginner guide at [`../docs/getting_started.md`](../docs/getting_started.md).
